...
MapCoordinatesToPixels::MapCoordinatesToPixels(const EventData &t_inputData, const PixelCoordinates &t_pixelCoordinates, TH1D *t_noiseHisto, const std::string t_outputFile) : 
		inputData(t_inputData), pixelCoordinates(t_pixelCoordinates), noiseHisto(t_noiseHisto), outputFile(t_outputFile) {
		
};

void MapCoordinatesToPixels::map() {
...
void MapCoordinatesToPixels::find2DHits(const unsigned &t_runID,
...
void MapCoordinatesToPixels::convertYZToPixelUnits(double &z, double &y) {
...
void MapCoordinatesToPixels::convertYZToROIandPixelIDs(const std::multimap<double, Hit> &t_dataHitOrder, 
...
void MapCoordinatesToPixels::convertToPCBCoordinates(double &z, double &y) {
	///Z component
...
bool MapCoordinatesToPixels::pcbCanSee(const double &z, const double &y, bool tpcCoor) {
